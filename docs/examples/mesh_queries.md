...
```text
mesh: 121 vertices, 200 cells, 40 boundary faces
point (0.23, 0.34) is in cell 65 with barycentric (0.600, 0.300, 0.100)
point (0.51, 0.72) is in cell 151 with barycentric (0.800, 0.100, 0.100)
point (0.87, 0.12) is in cell 36 with barycentric (0.300, 0.500, 0.200)
closest mesh point to (+1.35, +0.30) is (1.000, 0.300)
closest mesh point to (-0.20, +1.25) is (0.000, 1.000)
the ellipsoid intersects 26 of 200 cells
```

## Figures

![mesh_queries.svg](../img/mesh_queries__mesh_queries.svg)

---

*This page is generated by `docs/generate_examples.py` from [`examples/mesh_queries.cpp`](../../examples/mesh_queries.cpp); the output and figures above are produced by actually running it.*

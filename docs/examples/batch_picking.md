...
```text
64 ellipsoids were partitioned into 3 batches with sizes: 48 15 1
```

## Figures

![batches.svg](../img/batch_picking__batches.svg)

---

*This page is generated by `docs/generate_examples.py` from [`examples/batch_picking.cpp`](../../examples/batch_picking.cpp); the output and figures above are produced by actually running it.*

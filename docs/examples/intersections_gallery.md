...
| pair | intersecting | disjoint |
| --- | --- | --- |
| `point vs box` | <img src="../img/intersections_gallery__point_box_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__point_box_no.svg" width="290"><br>`intersects -> false` |
| `point vs ball` | <img src="../img/intersections_gallery__point_ball_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__point_ball_no.svg" width="290"><br>`intersects -> false` |
| `point vs ellipsoid` | <img src="../img/intersections_gallery__point_ellipsoid_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__point_ellipsoid_no.svg" width="290"><br>`intersects -> false` |
| `point vs simplex` | <img src="../img/intersections_gallery__point_simplex_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__point_simplex_no.svg" width="290"><br>`intersects -> false` |
| `box vs box` | <img src="../img/intersections_gallery__box_box_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__box_box_no.svg" width="290"><br>`intersects -> false` |
| `box vs ball` | <img src="../img/intersections_gallery__box_ball_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__box_ball_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs box` | <img src="../img/intersections_gallery__ellipsoid_box_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_box_no.svg" width="290"><br>`intersects -> false` |
| `box vs segment` | <img src="../img/intersections_gallery__box_segment_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__box_segment_no.svg" width="290"><br>`intersects -> false` |
| `box vs halfspace` | <img src="../img/intersections_gallery__box_halfspace_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__box_halfspace_no.svg" width="290"><br>`intersects -> false` |
| `box vs simplex` | <img src="../img/intersections_gallery__box_simplex_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__box_simplex_no.svg" width="290"><br>`intersects -> false` |
| `ball vs ball` | <img src="../img/intersections_gallery__ball_ball_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ball_ball_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs ball` | <img src="../img/intersections_gallery__ellipsoid_ball_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_ball_no.svg" width="290"><br>`intersects -> false` |
| `ball vs simplex` | <img src="../img/intersections_gallery__ball_simplex_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ball_simplex_no.svg" width="290"><br>`intersects -> false` |
| `ball vs segment` | <img src="../img/intersections_gallery__ball_segment_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ball_segment_no.svg" width="290"><br>`intersects -> false` |
| `ball vs halfspace` | <img src="../img/intersections_gallery__ball_halfspace_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ball_halfspace_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs ellipsoid` | <img src="../img/intersections_gallery__ellipsoid_ellipsoid_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_ellipsoid_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs simplex` | <img src="../img/intersections_gallery__ellipsoid_simplex_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_simplex_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs segment` | <img src="../img/intersections_gallery__ellipsoid_segment_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_segment_no.svg" width="290"><br>`intersects -> false` |
| `ellipsoid vs halfspace` | <img src="../img/intersections_gallery__ellipsoid_halfspace_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__ellipsoid_halfspace_no.svg" width="290"><br>`intersects -> false` |
| `simplex vs simplex` | <img src="../img/intersections_gallery__simplex_simplex_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__simplex_simplex_no.svg" width="290"><br>`intersects -> false` |
| `simplex vs segment` | <img src="../img/intersections_gallery__simplex_segment_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__simplex_segment_no.svg" width="290"><br>`intersects -> false` |
| `simplex vs halfspace` | <img src="../img/intersections_gallery__simplex_halfspace_yes.svg" width="290"><br>`intersects -> true` | <img src="../img/intersections_gallery__simplex_halfspace_no.svg" width="290"><br>`intersects -> false` |
...
point_ball_yes             -> true
point_ball_no              -> false
point_ellipsoid_yes        -> true
point_ellipsoid_no         -> false
point_simplex_yes          -> true
point_simplex_no           -> false
box_box_yes                -> true
box_box_no                 -> false
box_ball_yes               -> true
box_ball_no                -> false
ellipsoid_box_yes          -> true
ellipsoid_box_no           -> false
box_segment_yes            -> true
box_segment_no             -> false
box_halfspace_yes          -> true
box_halfspace_no           -> false
box_simplex_yes            -> true
box_simplex_no             -> false
ball_ball_yes              -> true
ball_ball_no               -> false
ellipsoid_ball_yes         -> true
ellipsoid_ball_no          -> false
ball_simplex_yes           -> true
ball_simplex_no            -> false
ball_segment_yes           -> true
ball_segment_no            -> false
ball_halfspace_yes         -> true
ball_halfspace_no          -> false
ellipsoid_ellipsoid_yes    -> true
ellipsoid_ellipsoid_no     -> false
ellipsoid_simplex_yes      -> true
ellipsoid_simplex_no       -> false
ellipsoid_segment_yes      -> true
ellipsoid_segment_no       -> false
ellipsoid_halfspace_yes    -> true
ellipsoid_halfspace_no     -> false
simplex_simplex_yes        -> true
simplex_simplex_no         -> false
simplex_segment_yes        -> true
simplex_segment_no         -> false
simplex_halfspace_yes      -> true
simplex_halfspace_no       -> false
```

---

*This page is generated by `docs/generate_examples.py` from [`examples/intersections_gallery.cpp`](../../examples/intersections_gallery.cpp); the output and figures above are produced by actually running it.*
